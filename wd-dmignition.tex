...
Ultimately, for DM massive enough to ignite the capture rate is of the form
\begin{align}
...
\end{equation}
Of course, direct detection~\cite{Aprile:2017iyp} constrain the DM-nuclei scattering cross section.
However, crucially these bounds 
...
\textcolor{blue}{\emph{If we change to $N_\text{halo}$, adjust this comment.}}
