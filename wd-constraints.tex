...
This fact does not weaken our constraints, however, since the energy $1-10~\text{MeV}$ transferred to each ion in the DM's path is larger than the $ \sim \text{MeV}$ needed per ion for fusion.
