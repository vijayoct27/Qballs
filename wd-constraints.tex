...
Note that the scattering cross sections constrained here are incredibly large $\gtrsim 10^{-10} ~\cm^2$---however, these constraints reach to very large masses for no other constraints exist. 
...
Constraints from the CMB/LSS \cite{Dvorkin:2013cea} are depicted as well. 
}
