...
As detailed in~\cite{Mack:2007xj}, underground direct detection experiments such as Xenon 1T~\cite{Aprile:2017iyp} and certain high-altitude detectors such as Skylab are only sensitive to DM masses $m_\chi < 10^{17} ~\GeV$. 
In principle, for even larger masses $m_\chi < 10^{26} ~\GeV$ there are constraints from the MACRO experiment \cite{Ambrosio:2002qq} and from ancient excavated mica---the latter has been studied in~\cite{Jacobs:2014yca}, and we have similarly estimated the bounds from MACRO. 
At even larger masses, the most stringent limits on DM elastic scattering are from CMB and Lyman-$\alpha$ spectrum analysis~\cite{Dvorkin:2013cea}. 
