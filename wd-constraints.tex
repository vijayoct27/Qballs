...
The NuStar collaboration has also recently uncovered evidence for the likely existence of $\sim 1.25 ~M_{\astrosun}$ WDs near the galactic center \cite{NuStar}, where it is estimated that $\rho_\chi \gtrsim 10^3 ~\text{GeV}/\text{cm}^3$ \cite{Nesti:2013uwa}.
...
Far more stringent bounds on captured DM can be obtained if we consider annihilations during a self-gravitational collapse.
This will be addressed in forthcoming work \cite{us}
In a similar manner, we constrain the lifetime $\tau_\chi$ in Figures \ref{fig:decayclasses} and \ref{fig:decayclassescap}.
