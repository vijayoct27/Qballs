...
%%%%%% Temporary packages for drafting
\usepackage{xcolor}
\usepackage[framemethod=TikZ]{mdframed} % use with \begin{mdframed}[style=MyFrame]
...
\usepackage{xpatch} % necessary patch for mdframed
\makeatletter
...
\title{\textcolor{blue}{Detecting Q-ball dark matter with White Dwarfs}}
...
% % \pacs{04.80.-y, 04.80.Cc, 03.75.Dg}% PACS, the Physics and Astronomy
