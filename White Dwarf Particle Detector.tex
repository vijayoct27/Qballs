...
The LPM effect ensures that hadronic interactions dominate at sufficiently high energies $\sim 10^4 - 10^6 ~\GeV$ even for electrons and photons.
...
If a single high-energy photon is produced, $\lambda_{\gamma A}$ only gives a displacement of the eventual heated region from the DM interaction vertex and $L_0$ does not depend on $\lambda_{\gamma A}$. 
...
This dominates over the bremsstrahlung of real photons at energies above $\sim 10^6 - 10^8 ~\GeV$. 
...
The showering processes described above terminate with a cloud of $\sim 10~\MeV$ neutrons, protons, and charged pions or $\sim 100~\MeV$ electrons and photons.
Of course, particles at these energies may also be directly produced by the DM.
In this regime, Coulomb, Compton, and elastic nuclear scatters are the dominant processes, and eventually lead to thermalization of ions.
