...
Thus for a heating event characterized by $L_0$ and $\Ez$, there is a \emph{boom condition}:
\begin{align}
...
As a result, understanding the \emph{heating length} $L_0$ for different types of heating events in a WD is critical to determining whether or not they are capable of destroying the star.
\begin{figure}
...
Having reviewed the requirements for runaway fusion, we turn to the question of igniting SN with DM.
