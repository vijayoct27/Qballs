...
\documentclass[twocolumn,showpacs,preprintnumbers,amsmath,amssymb,prd,superscriptaddress]{revtex4}
...
The existence of dark matter (DM) is strong evidence for new physics beyond the Standard Model (SM).
As with all of the matter content in the SM, it is natural to suspect that the DM also has non-gravitational interactions. 
...
Of course, this is not the only known heavy WD - the Sloan Digital Sky Survey has found $\sim 20$ others \cite{SDSS}.
...
Here we have outlined the myriad ways in which white dwarfs can act as detectors of these states. 
