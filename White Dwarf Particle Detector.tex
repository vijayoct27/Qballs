...
The energy loss of nucleons and pions is depicted in Figures \ref{fig:SPnuc} and \ref{fig:SPpion}.
First we consider the range of low-energy hadrons less than the nuclear binding energy $\epsilon \lesssim E_\text{nuc} \sim 10 ~\text{MeV}$. 
At these energies, protons and neutrons are stopped predominantly through elastic nuclear scatters, characterized by a typical mean free path $ l_\text{h,el} \sim 1/n_\text{ion} \sigma_\text{h,el}$. 
...
For sufficiently high energies, the result will be a roughly collinear hadronic shower. 
