...
We consider a general class of models in which DM-DM collisions, DM decays, or DM transits with a SM scattering interaction produce particles that subsequently deposit their energy inside the star.  
...
Consequently, \cite{Graham:2015apa} realized that if DM were capable of sufficiently heating a WD in this manner, it would ignite a SN of sub-Chandrasekhar Mass progenitor. 
...
In this paper, we extend the reach of WD DM ``detectors" to candidates with non-gravitational interactions that cause heating through the release of SM particles. 
...
We consider a general class of models in which DM-DM collisions, DM decays, or DM transits with a SM scattering interaction produce particles that subsequently deposit their energy inside the star. 
Constraints on these models come from either observing specific, long-lived WDs or by comparing the measured type Ia SN rate with the much larger rate expected due to DM events.
...
We are thus able to use WDs to rule out supersymmetric Q-ball DM in a vast region of parameter space. 
...
In Section~\ref{sec:SMHeating}, where we study the heating properties of SM particles and determine when the production of such particles results in a SN.
Detailed calculations of the stopping of high-energy particles in the WD medium are provided in Appendix \ref{sec:Appendix}.
