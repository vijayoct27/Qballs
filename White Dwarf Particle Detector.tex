...
\section{Stopping of Particles in a White Dwarf}
\label{sec:Appendix}
...
Their characteristic Coulomb interaction energy is
\begin{equation}
\label{eq:lattice}
  \Omega_l \sim \frac{Z^2 \alpha}{n_\text{ion}^{-1/3}}
         \sim 10^{-2}-10^{-1} ~\MeV.
\end{equation}
As $\Omega_l \gg T$, the ions form a Coulomb lattice with binding energy $\sim \Omega_l$.
