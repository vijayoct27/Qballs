...
Consequently, \cite{Graham:2015apa} realized that if DM were capable of sufficiently heating a WD in this manner, it would result in a SN of sub-Chandrasekhar Mass progenitor. 
...
In Section~\ref{sec:SMHeating} we study the heating of a WD that results from releasing SM particles in a WD. 
Detailed calculations of the stopping of high-energy particles in a WD are provided in Appendix \ref{sec:Appendix}.
In Section~\ref{sec:DMexplode} we parameterize the modes of DM-WD interaction that may produce SM particles, and in Section~\ref{sec:Constraints} we derive constraints on these interactions.
