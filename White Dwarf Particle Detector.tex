...
In the context of EM showers terminating at $E_\text{crit}\sim100~\MeV$, the final-state electrons and photons will establish an EM of initial temperature $T \lesssim E_\text{crit}$ with length scale $\lambda_\text{brem}$.
...
This barely allows photonuclear showers at high density, and so we conservatively take EM shower products to thermailizes ions through Coulomb interactions. 
