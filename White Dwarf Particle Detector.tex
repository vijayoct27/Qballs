...
\begin{equation}
\Gamma_\text{earth} \sim \int_{\text{halo}} \l \frac{\rho_\text{DM}(r)}{m_\text{DM}}\r \frac{R_\text{det}^2}{L^2} \frac{1}{\tau_\text{DM}},
\end{equation}
...
Lastly, DM-DM annihilations into electrons and photons would cause ionization and therefore affect the measured CMB temperature profile and fluctuations. 
