...
For DM-DM collision heating, there is high probability that the collapse of the core will induce an ignition event due to the enhancement of DM number density during the collapse.
 
one has both a large 
...
% \begin{align}
% R_\text{vr} &\sim \l \frac{T}{G m_\text{DM} \rho_\text{WD}}\r^{1/2} \approx 10^{-3} ~\text{m} \l \frac{10^{16} ~\GeV}{m_\text{DM}}\r^{1/2} \l \frac{10^{31} ~\cm^{-3}}{n_\text{ion}}\r^{1/2}, \nonumber
% \end{align}
% where we have assumed the WD has roughly constant density within a sphere of radius $R_\text{vr}$.
...
% \begin{align}
% \label{eq:tcol}
% t_\text{collapse} &\sim \l \frac{\rho_\text{WD} R_\text{vr}^3}{m_\text{DM} \Gamma_\text{transit}} \r \approx 10 ~\text{s} \l \frac{10^{16} ~\GeV}{m_\text{DM}} \r^{3/2} \l \frac{10^{31} ~\cm^{-3}}{n_\text{ion}}\r^{1/2}.
% \end{align}
...
% $R_\text{sta}$ is at least as large as the Schwarzschild radius for the collapsed mass of DM, $R_\text{sch} \sim R_\text{vr} v_\text{th}^2$.
