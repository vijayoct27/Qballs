...
As discussed in Section~\ref{sec:Review}, a DM encounter with a WD must efficiently transfer energy to ions as characterized by the heating length $L_0$ and total energy deposit $\Ez$ for the process. 
...
However, non-gravitational interactions also have the potential to ignite SN. 
In particular, any DM candidate which couples non-gravitationally to the SM will generically be able to release SM secondaries though some effective process shown in Figure \ref{fig:Feynman}, thereb
