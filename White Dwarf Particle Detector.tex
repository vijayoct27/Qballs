...
% forgive me Vijay 
% , and the WD may be thought of as a detector with hadronic and electromagnetic ``calorimeter'' components.
Constraints on these DM candidates come from either observing specific, long-lived WDs or by comparing the measured type 1a SN rate with that expected due to DM.  
It is important to note that these constraints are complimentary to direct searches---it is more massive DM that is likely to trigger SN, but also more massive DM that has low terrestrial flux.
...
And as a concrete example, we consider ultra-heavy Q-balls DM as found in supersymmetric extensions of the SM, which we rule out in a vast region of parameter space.
...
Finally we specialize to the case of Q-ball DM in Section~\ref{sec:QBalls}, and conclude in Section~\ref{sec:Discussion}.
...
We calculate the distance over which electrons, 
