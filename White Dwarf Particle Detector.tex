...
For a cosmic ray detector with area $ \sim (50~\text{km})^2$ \textcolor{blue}{\cite{big array}}, we find that the cosmic ray bounds are weaker than the WD bounds except in the DM decay ``wind scenario", where the cosmic rays bounds are comparable within a couple orders of magnitude to those due to the observation of a local WD.
