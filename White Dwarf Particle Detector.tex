...
In general, $L_0$ may depend on the exact nature of the DM model, yet any DM candidate that couples to the SM will generically be able to heat the star by releasing SM particles, as outlined in more detail \ref{sec:DMexplode}.
In such processes, DM physics serves only to determine the initial spacial distribution and spectrum in energy and species of SM particles produced in the star, while the actual heating proceeds though SM interactions. 
Understanding the heating length of such processes necessarily requires an understanding of how energy is transfered from SM particles to the stellar medium, so in this section we summarize the heating properties of individual SM particles of given energy $\epsilon$ and species $i$. 
These results serve as building blocks for calculating the full heating length $L_0$ of any DM-WD encounter that heats the star though SM mediators, which may involve any number of SM particles, species, and energies. 
