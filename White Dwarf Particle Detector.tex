...
\label{sec:Appendix}
Here we provide a detailed analysis of the electromagnetic and strong interactions in a carbon-oxygen WD, aimed towards calculating the energy loss per distance traveled (stopping power) for electrons, photons, and light hadrons within the stellar medium at energies greater than $1\,\text{MeV}$.
...
For $M \gtr 0.85 M_{\odot}$ the electrons are relativistic and have Fermi energy
\begin{equation}
...
\label{eq:lattice}
  \omega \sim \frac{Z^2 \alpha}{n_\text{ion}^{-1/3}}
         ...
         \gg T,
\end{equation}
so they form a Coulomb lattice with binding energy $\sim \omega$.
