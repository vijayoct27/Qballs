...
An essential ingredient in this analysis is understanding how individual SM particles deposit energy in a WD medium. 
We find that through strong and electromagnetic interactions a generic high energy particle will shower into a cloud of $\sim 1-10~\MeV$ secondaries that efficiently thermalize with the WD via elastic scatters.
In this regard, the WD may be thought of as a detector with hadronic and electromagnetic ``calorimeter'' components.
Particle production is thus an effective means of inducing SN, provided sufficient total energy is released.
This is used to constrain DM models with variety of SM production modes: DM-DM collisions or DM decays, transits with a DM-SM scattering interaction, and DM capture scenarios.
...
We constrain Q-ball DM in regions of parameter space fundamentally inaccessible to terrestrial experiments.
