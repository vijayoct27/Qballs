...
For cosmic ray detectors smaller than $ \sim 1~\text{km}^2$, we find that the cosmic ray bounds are always weaker than the WD bounds, but in the DM collision ``wind scenario" the cosmic rays bounds are similar to those due to the observation of a local WD.
