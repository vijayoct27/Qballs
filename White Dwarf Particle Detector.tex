...
The number of DM particles contained in a WD volume is approximately $N_\text{DM} \sim \frac{\rho_{\text{DM}}}{m_\text{DM}} \frac{v_\text{esc}}{v} R_\text{WD}^3$, taking into account the gravitationally enhanced DM density within the star. Therefore, the expected DM-DM collision rate parameterized by cross section $\sigma_\text{col}$ is 
\begin{equation}
