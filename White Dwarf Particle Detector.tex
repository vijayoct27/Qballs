...
\begin{figure}
\includegraphics[scale=.5]{triggerboom}
\end{figure}
...
\begin{figure}
\includegraphics[scale=.35]{hadronic}
\end{figure}
...
\begin{figure}
\includegraphics[scale=.5]{boomQball}
\end{figure}
