...
\end{equation}
\textcolor{blue}{to order 1 can ignore ``g" factor difference between decays and collisions.} Considering the explosion threshold \eqref{eq:Eboom}, this process requires ultra-heavy DM $m_\text{DM} \gtrsim 10^{14} ~\GeV$. in order to ignite the most dense WDs. 
