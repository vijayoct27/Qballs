...
\caption{Stopping Length high EM}.
\label{fig:SPhighEM}
\end{figure}

\begin{figure}
\includegraphics[scale=.3]{SPlowEM.pdf}
\caption{Stopping Length low EM}.
\label{fig:SPlowEM}
\end{figure}

\begin{figure}
\includegraphics[scale=.3]{SPhighHad.pdf}
\caption{Stopping Length high Had}.
\label{fig:SPhighHad}
\end{figure}

\begin{figure}
\includegraphics[scale=.3]{SPlowHad.pdf}
\caption{Stopping Length low Had}.
\label{fig:SPlowHad}
\end{figure}
...
\begin{align}
  ...
  \l\frac{10^{32}~\text{cm}^{-3}}{n_\text{ion}}\r
\end{align}
and are plotted in Figures \ref{fig:SPhighEM}, \ref{fig:SPlowEM}. 
