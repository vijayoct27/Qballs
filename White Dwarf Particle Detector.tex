...
\end{align}
developed in Section~\ref{sec:DMexplode}, along with the diffusion conditions discussed there. The expected number of ultra-heavy dark matter transits through a white dwarf with lifetime $t_\textrm{WD} \sim \textrm{Gyr}$ is given by
\begin{align}
N_\textrm{transits}  &= t_\textrm{WD} \cdot n_\text{DM} \sigma_g v \\
 &  \sim t_\textrm{WD} \cdot \frac{\rho_{\text{DM}}}{m_\text{DM}} \pi R_{s}^2 \l\frac{v_\text{esc}}{v}\r^2 v,
\end{align}
