...
\end{equation}
where $k$ denotes the energy of the incident photon. 
...
\end{equation}
Since the electrons in a WD are sufficiently relativistic, the Thomson scattering limit is never applicable. 
