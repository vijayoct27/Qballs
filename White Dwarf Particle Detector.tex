...
\end{equation} 
where $E_0$ and $E_f$ denote the initial and final energy of the incident particle, averaged over all scattering angles. For instance, a nucleon interacting with carbon nuclei transfers roughly 15\% of its incident energy after each elastic collision. This makes the WD a decent ``moderator". 
