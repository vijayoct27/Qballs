...
\end{equation}
Imposing \eqref{eq:explosion} in the case of $L < \lambda_T$, we find a model-independent lower bound on $m_{\text{DM}}$ such that the DM is able to both penetrate the crust \emph{and} trigger an explosion:
\begin{equation}
