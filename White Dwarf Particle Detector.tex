...
White dwarves can function as detectors for ultra-heavy dark matter states which interact sufficiently to trigger type 1A supernovae. This was originally proposed in \cite{Graham:2015apa} and applied to place bounds on primordial black holes. In this paper, we extend the analysis of \cite{Graham:2015apa} to general dark matter candidates with non-gravitational couplings, focusing on dark matter transits and annihilations within the white dwarf. A benchmark candidate is the supersymmetric Q ball, which we constrain beyond current limits. More generally, we provide a detailed analysis of the explosive power of any mechanism capable of interacting with the white dwarf through standard model couplings. This can be used to constrain future proposed candidates for dark matter including models of composite dark matter and self-interacting dark matter.  
...
Therefore, a region with temperature greater than $T_F$ and size greater than $\lambda_T$ in a given WD will launch a runaway fusion chain-reaction and result in a type IA supernovae. In this regard, white dwarves are uniquely qualified to serve as DM detectors when a sufficiently large region is heated to ignite runaway fusion. 

\textcolor{blue}{Paragraph about what we are going to do new in this paper...}.
In this paper, we constrain DM candidates which interact with WD constituents release energy in the form of standard model (SM) particles. This in contrast to gravitational heating as done in \cite{Graham:2015apa}. Weaknesses - other ignition sources exist (i.e., detector backgrounds). What constraints can be placed in light of this? 
