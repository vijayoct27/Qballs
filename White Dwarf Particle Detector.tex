...
For the rest of this section, we will assume that these particles are released in a WD density of $n_e \sim 10^{33} ~\cm^3$ - lower densities can be calculated 
...
This results in a roughly collinear hadronic shower that terminates when shower constituents reach a critical energy of order the nuclear binding energy $\sim 10 ~\text{MeV}$ or when Coulomb collisions become more dominant. 
For the WD densities of most interest to us, 
...
Hence, there will be negligible electromagnetic contributions from $\pi^0$ decays during the progression of a hadronic shower for all but the lowest WD densities.  
...
A similar cutoff occurs in the stopping of heavy charged hadrons (i.e., protons and pions), although in this case strong interactions will be a more dominant source of energy loss to nuclear targets than Coulomb scattering at these energies. 
...
For instance, the energy loss due to electron direct pair production $eN \to e^+ e^- e N$ has been calculated in \cite{Gerhardt:2010bj} and is found to exceed that of bremsstrahlung at an energy $\sim 10^{10} ~\GeV$. 
