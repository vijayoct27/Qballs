...
\end{equation}
The moral of the explosion condition~\ref{eqn:boom} is that for a heating event to be capable of destroying a given WD, both the energy density and the energy deposited must be sufficiently large. Note that there is a minimum explosion energy $E_{\text{boom}}$ set by:
\begin{equation}
