...
In this section we discuss the DM-dependent aspects of non-gravitational heating of white dwarfs. 
In particular, we parameterize the possible DM-WD encounters that may give rise to WD heating in this fashion and derive conditions on the interaction parameters that determine if such encounters result in nuclear runaway.
