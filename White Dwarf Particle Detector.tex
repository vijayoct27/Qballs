...
These terminate in a cloud of electrons and photons at some critical energy $E_\text{crit}$, set by the scale at which radiative processed become subdominant to elastic or hadron interactions.
This is a strong function of WD density, ranging between $100~\MeV$ and $10^6~\MeV$, as evidenced by \textcolor{blue}{figure}.
Note that these processes are strictly forbidden below the electron Fermi energy.  
