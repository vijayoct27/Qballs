...
With this restriction, the explosion condition depends only on the total SM energy released and the heating length of the products.  Since the DM involved in this process is non-relativistic, the available energy for SM products is $\sim m_\text{DM}$ and we parameterize the released SM energy as a fraction $\eta$ of the DM mass.  The explosion condition is:
\begin{equation}
\label{eq:coldecay}
