...
We demonstrate these constraints for generic classes of DM models that produce SM particles via DM-DM collisions, DM decays, or DM-SM inelastic scattering, and consider the significantly enhanced constraints for DM that is captured in the star.
...
This requires some facts of DM capture, which are worked out in Appendix \ref{sec:capture}.
