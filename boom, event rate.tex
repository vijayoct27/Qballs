...
\end{align}
Essentially, the number of collapsing DM particles is depleting by an $\OO(1)$ fraction once the DM sphere has focused to within the minimum of either scale:
\begin{equation}
...
\end{equation}
However, the collapsing DM sphere will still form a BEC once it reaches a critical density. 
At this radius, further collapse of the full $N_\text{sg}$ number goes towards populating the newly formed condensate.
