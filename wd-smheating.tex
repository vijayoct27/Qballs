...
The first effect suppresses the stopping power by a factor of $v_\x{in}^2$ relative to that of stationary, non-degenerate targets and the second by an additional $v_\x{in}$---together, this yields for light hadrons stopping powers that are $\sim 10^{-6}$ smaller than their typical terrestrial values. 
