...
Like the hadronic elastic scatters, an electron scattering off ions will undergo a random walk, with a number of steps given by the number of hard scatters it experiences before depositing $\OO(1)$ of its energy.
