...
We find that SM particles efficiently heat the WD regardless of species (neutrinos are a slight exception) or energy---the heating length is typically less than or of order the trigger size $\lambda_T \sim 10^{-5}~\cm$. 
...
A schematic for the flow of energy during deposition is given in Figure \ref{fig:heating-cartoon}.
...
\end{equation}
which is at most of order the trigger size.
