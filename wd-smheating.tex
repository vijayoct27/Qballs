...
At an energy of $\sim 10^{11} ~\GeV$, the neutrino-nuclear cross section is determined to be $\sim 10^{-32} ~\cm^2$ \cite{Formaggio:2013kya}.
Conservatively assuming this value for even higher energies yields a neutrino mean free path of order $\sim 10 ~\cm$. 
...
As such, a \emph{single} ultra-high energy neutrino released in the WD will heat the star just as high-energy hadrons do. 
...
This is due to the significant Pauli-blocking of electron interactions near the Fermi energy $E_F \sim 1-10~\MeV$, see Appendix \ref{sec:coulomb_elec}. 
