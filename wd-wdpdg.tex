...
For incident momenta much greater than the Fermi momentum, the relative velocity is of order the incident velocity and the deflection of the incident particle will be generally small. 
We thus expect scattering to proceed up to $\OO(1)$ factors as though a heavy incident particle is striking a light, stationary target.  
...
This is admittedly heuristic, though its accuracy can be verified with a detailed calculation.  

Equation~\eqref{eq:CoulombRelativisticApprox} also ignores plasma screening, as Pauli-blocking will provide the most stringent cutoff on soft scatters in this case. 
Scatters that transfer an energy $\omega \leq E_F$ will have a suppressed contribution to the stopping power as they only occur with WD electrons near the top of the Fermi sea. 
It is sufficient to ignore these suppressed scatters, which gives a stopping power 
\begin{align}
...
This is a good estimate of the stopping power provided the incident electrons have energy much larger than $E_F$. 
...
For incident energies less than Fermi energy, this stopping power is parametrically modified by electron motion and Pauli-blocking. 
