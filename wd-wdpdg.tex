...
Scatters that transfer an energy $\omega \leq E_F$ will have a suppressed contribution to the stopping power as the only occur with WD electrons near the top of the Fermi sea. 
We simply ignore these suppressed scatters, which gives a stopping power 
\begin{align}
