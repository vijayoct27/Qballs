...
This can be estimated with the Weizsacker-Williams approximation, which gives a stopping power that is scaled from the photonuclear result by $\alpha$ as well as an $\OO(10)$ kinematic factor~ \cite{Gerhardt:2010bj}: 
\begin{align}
    \frac{dE}{dx} \sim 10^{-3} \cdot \sigma_\inel n_\ion E.
\end{align}
...
\paragraph{Compton Scattering off Electrons.}
\label{sec:compton}
